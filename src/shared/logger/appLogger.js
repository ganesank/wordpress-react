...
export class AppLogger {
  constructor() {     
    ...
    switch(this.logLevel){
      case 'TRACE': this.logLevelValue = loggerLevel.TRACE; break;
      case 'DEBUG': this.logLevelValue = loggerLevel.DEBUG; break;
      case 'INFO': this.logLevelValue = loggerLevel.INFO; break;
      case 'LOG': this.logLevelValue = loggerLevel.LOG; break;
      case 'WARN': this.logLevelValue = loggerLevel.WARN; break;
      case 'ERROR': this.logLevelValue = loggerLevel.ERROR; break;
      default: this.logLevelValue = loggerLevel.OFF; 
    }    
  ...
  doLog = (level, message, data = '') => {
    ...
    let messageLogLevel = '';
    switch(level){
      case 0: messageLogLevel = 'TRACE';  break;
      case 1: messageLogLevel = 'DEBUG';  break;
      case 2: messageLogLevel = 'INFO';  break;
      case 3: messageLogLevel = 'LOG';  break;
      case 4: messageLogLevel = 'WARN';  break;
      case 5: messageLogLevel = 'ERROR';  break;    
      default: messageLogLevel = '';  
    }    
    ...
    if (this.serverEnabled) {
      if (typeof data === 'object') {
        try {
          ...
          data = 'circular object in message. value: ' + data;
        }
      }
      this.logToServer(messageToLog, data);
    }    
  }
  ...
  logToServer = (message, data) => {
    ...
    logsToSend.push({ log: message, data: data });
